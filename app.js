...
const PUBLIC_SITE_URL = "https://gogyo-outfit-daily-ja.pages.dev/";
...
function fetchJsonFromLocalFile(url, originalError) {
...
function bindActions() {
  ...
  els.shareButton.addEventListener("click", () => {
    ...
    const url = new URL(isLocalFilePage() ? PUBLIC_SITE_URL : window.location.href);
